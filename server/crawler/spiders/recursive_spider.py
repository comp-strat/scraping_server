...
CSV is expected to be structured with a unique target identifier (for schools this is the NCES school number or NCESSCH) and URL like so:
...
class RecursiveSpider(CrawlSpider):
    ...
    def __init__(self, target_list=None, rq_id=None, mongo_settings= {}, user=None, url=None, *args, **kwargs):
        ...
        - domain_to_id:
            ...
            a number representing the target id defined by
            csv_input.
        """
        ...
        self.rules = (
            Rule(CustomLinkExtractor(
                allow_domains=self.allowed_domains), follow=True,
                callback="parse_items",
    ...
    def init_from_target_list(self, target_list):
        """
        Generate's this spider's instance attributes
        from the input list of target entities, formatted as a CSV or TSV.
        
        Target List's format:
        ...
        Args:
            target_list: Is the path string to this file.
        Returns:
